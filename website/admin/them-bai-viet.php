...
<?php
	if (isset($_POST["btn_submit"])) {
		...
		$sql = "INSERT INTO posts(title, content, user_id, is_public, createdate, updatedate, tai_nguyen) VALUES ( '$title', '$content', '$user_id', '$is_public', '$tai_nguyen', now(), now())";
	...
	<form action="them-bai-viet.php" method="post">
		<table>
			...
			<tr>
				...
				<td><textarea type="text" name="tai_nguyen" id="tai_nguyen"></textarea></td>
			</tr>
			<tr>
